...
public class Constraints {
    public static TrajectoryVelocityConstraint FAST_VEL = SampleMecanumDrive.getVelocityConstraint(44, Math.toRadians(270), DriveConstants.TRACK_WIDTH);
    public static TrajectoryVelocityConstraint NORMAL_VEL = SampleMecanumDrive.getVelocityConstraint(37, Math.toRadians(180), DriveConstants.TRACK_WIDTH);
