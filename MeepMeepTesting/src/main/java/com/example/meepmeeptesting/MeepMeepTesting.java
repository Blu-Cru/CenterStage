...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity placementLeft = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive ->
                        drive.trajectorySequenceBuilder(new Pose2d(10, -61, Math.toRadians(-90)))
                                ...
                                .splineToLinearHeading(new Pose2d(8, -38, Math.toRadians(-30)), Math.toRadians(150))
                                .build()
                );

        RoadRunnerBotEntity depositScan = new DefaultBotBuilder(meepMeep)
                // Set bot constraints: maxVel, maxAccel, maxAngVel, maxAngAccel, track width
                .setConstraints(30, 30, Math.toRadians(180), Math.toRadians(180), 12)
                .followTrajectorySequence(drive ->
        ...
        meepMeep.setBackground(MeepMeep.Background.FIELD_CENTERSTAGE_JUICE_DARK)
                ...
                .addEntity(placementLeft)
                .addEntity(depositScan)
                .addEntity(depositCenter)
                .start();
    }
}